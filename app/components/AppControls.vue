        ...
        <div class="space-y-4 text-sm p-4 overflow-y-auto max-h-[70vh]">
          ...
          <section>
            ...
            >
              ...
              <li>
                <strong>Контекстное меню узла:</strong> правый клик (или долгое нажатие на смартфоне)
                для настройки мощности (1-30 дБм), высоты (0-200м), лимита прыжков (1-7) и удаления узла
              </li>
              <li>
          ...
          <section>
            ...
            >
              <li>
                <strong>Дальность связи:</strong> зависит от мощности и высоты узлов
                <ul class="list-circle list-inside ml-4 mt-1 space-y-0.5">
                  <li>Базовая (на земле, 20 дБм): 600 м</li>
                  <li>На высоте 20м: ~5.5 км</li>
                  <li>На высоте 100м: ~25 км</li>
                  <li>Максимум (200м): 50 км</li>
                </ul>
              </li>
              <li>
                <strong>SNR-based Reception:</strong> вероятность приема зависит от отношения
                сигнал/шум и высоты узлов
              </li>
              <li><strong>CSMA:</strong> узлы проверяют, не занят ли канал перед передачей</li>
              <li>
                <strong>Hop Limiting:</strong> пакеты имеют ограничение на количество переходов
                (по умолчанию 3)
              </li>
              <li>
                <strong>Duplicate Suppression:</strong> узлы подавляют повторную ретрансляцию
                дубликатов
              </li>
            </ul>
          </section>
